...
output_dir = "/shared/mrkouch/OTT-QA/work-with-OTT-QA/1000_random_tables"
...
# Sample 1000 files
sampled_files = random.sample(table_files, 1000)
...
print(f"Moved 1000 random tables to {output_dir}")
