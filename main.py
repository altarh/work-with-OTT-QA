...
# Replace with actual filenames you want
files = ['10,000_metres_0', '10,000_metres_1']
base_url = 'https://raw.githubusercontent.com/wenhuchen/OTT-QA/master/data/traindev_tables_tok/'

for file in table_ids_not_gold:
